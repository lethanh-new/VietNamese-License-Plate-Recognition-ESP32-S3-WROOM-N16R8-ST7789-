...
## Phần mềm
- tải yolov5 : [yolov5 - goodle drive
...
Dự án này được thực hiện với sự tham khảo và kế thừa một phần từ các nguồn mã nguồn mở và bộ dữ liệu công khai.

## Mã nguồn tham khảo

Nhóm có tham khảo và sử dụng một phần mã nguồn từ dự án:

**License-Plate-Recognition**  
Tác giả: **trungdinh22**  
GitHub: https://github.com/trungdinh22/License-Plate-Recognition

Các nội dung được tham khảo bao gồm:
- Phát hiện biển số bằng YOLOv5.
- Hiệu chỉnh góc nghiêng (Deskew).
- Nhận dạng ký tự trên biển số (OCR).

Trên cơ sở đó, nhóm đã nghiên cứu, chỉnh sửa và phát triển thêm các chức năng:
- Tích hợp ESP32-S3 CAM.
- Truyền ảnh từ ESP32-S3 CAM đến máy chủ Python thông qua giao thức HTTP.
- Truyền kết quả nhận diện về ESP32-S3 bằng TCP Socket.
- Tra cứu mã tỉnh thành của biển số xe Việt Nam.
- Hiển thị kết quả trên màn hình TFT ST7789.
- Tối ưu luồng xử lý phù hợp với hệ thống thời gian thực.
---

**Lưu ý:** Đây là dự án học tập phục vụ mục đích nghiên cứu và báo cáo môn học. Nhóm xin chân thành cảm ơn các tác giả đã công bố mã nguồn và bộ dữ liệu, tạo điều kiện thuận lợi cho quá trình nghiên cứu và phát triển hệ thống.